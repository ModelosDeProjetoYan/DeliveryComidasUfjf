...
CREATE TABLE FUNCIONARIO(
    ...
    ID_RESTAURANTE INTEGER NOT NULL,
    ID_USUARIO INTEGER NOT NULL,
    TIPO_USER_RESTAURANTE VARCHAR (150)  NOT NULL,
    FOREIGN KEY (ID_RESTAURANTE) REFERENCES RESTAURANTE(ID),
    FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(ID)
);
...
INSERT INTO PEDIDO(ESTADO, DATA_PEDIDO, ID_END ,ID_USUARIO, ID_RESTAURANTE) values ('Aberto','2018-11-10',1, 1, 1);
...
INSERT INTO funcionario(ID_RESTAURANTE,ID_USUARIO,TIPO_USER_RESTAURANTE) VALUES(1,1,'Gerente');
INSERT INTO funcionario(ID_RESTAURANTE,ID_USUARIO,TIPO_USER_RESTAURANTE) VALUES(1,4,'ChefeDeCozinha');
INSERT INTO funcionario(ID_RESTAURANTE,ID_USUARIO,TIPO_USER_RESTAURANTE) VALUES(1,5, 'Entregador');
INSERT INTO funcionario(ID_RESTAURANTE,ID_USUARIO,TIPO_USER_RESTAURANTE) VALUES(2,2,'Gerente');
INSERT INTO funcionario(ID_RESTAURANTE,ID_USUARIO,TIPO_USER_RESTAURANTE ) VALUES(3,3,'Gerente');